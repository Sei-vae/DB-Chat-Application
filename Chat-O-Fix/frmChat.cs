    ...
    public partial class frmChat : Form
    {
        ...
        private void btnSend_Click(object sender, EventArgs e)
        {
            ...
            if (!String.IsNullOrEmpty(txtAlias.Text) && !String.IsNullOrEmpty(txtQuote.Text))
            {
                ...
                MySqlConnection myConnection = new MySqlConnection("SERVER=localhost;DATABASE=chatofix;UID=root;PASSWORD=;");
                myConnection.Open();

                //Einfüge SQL-Befehl zusammenbauen.
                string myInsertQuery = "INSERT INTO t_chatquote (alias, quote, timestamp) Values('" + txtAlias.Text + "', '" + txtQuote.Text + "', '" + DateTime.Now.ToString("yyyy-MM-dd HH:mm") + "')";
